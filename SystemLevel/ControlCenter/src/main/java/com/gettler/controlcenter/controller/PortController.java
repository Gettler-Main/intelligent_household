...
public class PortController {
    ...
    public Result addport(@ApiParam(name = "num", value = "端口号", required = true, example = "50001") Integer num, @ApiParam(name = "userid", value = "用户ID", required = true, example = "1") Integer userid) {
        ...
        if (port.isEmpty()) {
            portMapper.insert(new Port(userid,num));
    ...
    public Result updateport(@ApiParam(name = "num", value = "端口号", required = true, example = "50001") Integer num, @ApiParam(name = "userid", value = "用户ID", required = true, example = "1") Integer userId, @ApiParam(name = "newnum", value = "新端口号", required = true, example = "50002") Integer newnum) {
        PortExample portExample = new PortExample();
        ...
        return Result.success(portMapper.updateByExample(new Port(ports.get(0).getUserid(), newnum), portExample));
    }
